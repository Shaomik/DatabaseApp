...
def print_menu():
    ...
    print "16. Shows the count of the tweets for  movie id"
    print "17. Finds the count of the tweets by the movie genre"
    print "18. Shows the count of the tweets by the movie title and screen name of twitters"
    print "19. number of tweets by movies with movie name"
    print "20. number of tweets by movies without losing empty groups"   
...
def query16():
    ...
    is_success = True
    query = "select movies.movie_id, count(*) tweet_count from Movies join Tweet on movies.movie_id = tweet.movie_id group by movies.movie_id;"
    try: 
        connection = create_connection()
        cursor = connection.cursor()
...
def query17():
    ...
    is_success = True
    query = "select movies.genre, count(*) as tweet_count from Movies join Tweet on movies.movie_id = tweet.movie_id group by movies.genre;"
    try: 
        connection = create_connection()
        cursor = connection.cursor()
...
def query18():
    ...
    is_success = True
    query = "select movies.title, tweet.screen_name, count(*) as tweet_count from Movies join Tweet where movies.movie_id = tweet.movie_id group by tweet.screen_name;"
    try: 
        connection = create_connection()
        cursor = connection.cursor()
...
def query19():
    ...
    is_success = True
    query = " select movies.title, movies.movie_id, count(*) as tweet_count from Movies join Tweet  on movies.movie_id = tweet.movie_id group by movies.title, movies.movie_id order by tweet_count desc;"
    try: 
        connection = create_connection()
        cursor = connection.cursor()
...
def query20():
    ...
    is_success = True
    query = "select movies.title, movies.movie_id, count(tweet.tweet_id) as tweet_count from Movies left outer join Tweet on movies.movie_id = tweet.movie_id group by movies.title, movies.movie_id order by tweet_count desc;"
    try: 
        connection = create_connection()
        cursor = connection.cursor()
...
while True:          
    ...
    if choice== 1:     
        ...
        print "You have chosen to show Choice 16. Results are added to the database "
        query16()   
    elif choice==17:
        print "You have chosen to show Choice 17. Results are added to the database "
        query17()   
    elif choice==18:
        print "You have chosen to show Choice 18. Results are added to the database "
        query18()   
    elif choice==19:
        print "You have chosen to show Choice 19. Results are added to the database "
        query19()   
    elif choice==20:
        print "You have chosen to show Choice 20. Results are added to the database "
        query20()   
    elif choice==21:
        print "You have chosen to show Choice 20. Results are added to the database "
        query21()                                                                                
